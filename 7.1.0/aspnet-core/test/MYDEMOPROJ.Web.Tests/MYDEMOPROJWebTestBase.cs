...
{
    public abstract class MYDEMOPROJWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MYDEMOPROJWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MYDEMOPROJWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MYDEMOPROJDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MYDEMOPROJDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MYDEMOPROJDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MYDEMOPROJDbContext, Task<T>> func)
        {
            T result;
